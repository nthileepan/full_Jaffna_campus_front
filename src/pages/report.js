...
const App = () => {
  const downloadExcel = async () => {
    try {
      ...
      const formattedData = timetableData.map((item) => ({
        ...
        Batch: item.batch,
        "Lecture Hall": item.lecture_hall,
      ...
      alert("An error occurred while downloading the timetable.");
    }
  };
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial" }}>
      ...
      <button onClick={downloadExcel} style={{ padding: "10px 20px", fontSize: "16px", cursor: "pointer" }}>
